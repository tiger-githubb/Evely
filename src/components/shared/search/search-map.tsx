...
export function SearchMap({ events }: SearchMapProps) {
  ...
  const [radius, setRadius] = useState(15000); // 15km default radius
  ...
  return (
    <div className="space-y-4">
      <div className="p-4 bg-white rounded-lg shadow">
        ...
        <Slider value={[radius]} onValueChange={(value) => setRadius(value[0])} min={1000} max={50000} step={1000} className="mt-2" />
      </div>
